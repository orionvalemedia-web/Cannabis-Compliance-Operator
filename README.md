# Cannabis Compliance Operator

An offline compliance tool for licensed cannabis dispensaries, cultivators and processors.
...
| Product | Scale |
|---|---|
| Devadex Cannabis Compliance Operator | 76 tests |

It is described in [PRODUCTS.md](PRODUCTS.md).
